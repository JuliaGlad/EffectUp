...
class AddMonthlyTaskDialogFragment(
    val isNew: Boolean,
    val yearId: String,
    val year: String,
    val monthId: String,
    ...
    private val viewModel: AddMonthlyTaskViewModel by viewModels()
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        binding.buttonAdd.setOnClickListener {
            ...
            if (binding.editLayoutTitle.getText()?.isNotEmpty() == true) {
                ...
                flag?.let {
                    viewModel.addTask(isNew, yearId, year, monthId, month,
                        taskId!!, task.toString(), flag.toString())
                }
            }
        }
