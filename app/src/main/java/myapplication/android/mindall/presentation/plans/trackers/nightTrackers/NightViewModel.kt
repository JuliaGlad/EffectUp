...
class NightViewModel : ViewModel() {
    ...
    fun getYearId(year: String) {
        NightTrackersDI.getYearIdUseCase.invoke(year)
    ...
    fun getMonthTrackers(yearId: String, monthId: String) {
        NightTrackersDI.getNightTrackersUseCase.invoke(yearId, monthId)
            .subscribeOn(Schedulers.io())
    ...
    fun getMonthId(yearId: String, month: String) {
        NightTrackersDI.getMonthIdUseCase.invoke(yearId, month)
            .subscribeOn(Schedulers.io())
            .subscribe(object : SingleObserver<String> {
                override fun onSubscribe(d: Disposable) {
